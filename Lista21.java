...
public class Lista21 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Multiplicação: " + mult(m1, m2));
		System.out.println(linha());
		...
		System.out.println("Resultado: " + Aprovacao(na1, na2));
		System.out.println(linha());
		...
		System.out.println("Temperatura em Fahrenheit: " + converter(celsius));
		System.out.println(linha());
		...
		System.out.println("Área: " + AreaRetangulo(base, altura));
		System.out.println(linha());
		...
		System.out.println("Resultado: " + juntar(nome1, nome2));
		System.out.println(linha());

		// 12 
		System.out.println("Digite sua idade: ");
		int idade = scanner.nextInt();
		System.out.println("Classificação: " + avaliar(idade));
		System.out.println(linha());
	}
	...
	public static String juntar(String nome1, String nome2) {
		return nome1 + " " + nome2;
	}

	public static String avaliar(int idade) {
		if (idade < 12) {
			return "Criança";
		} else if (idade < 18) {
			return "Adolescente";
